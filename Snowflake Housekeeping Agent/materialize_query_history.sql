...
CREATE INDEX IF NOT EXISTS IDX_QH_MAT_START_TIME ON QUERY_HISTORY_MATERIALIZED(START_TIME);
CREATE INDEX IF NOT EXISTS IDX_QH_MAT_USER_NAME ON QUERY_HISTORY_MATERIALIZED(USER_NAME);
CREATE INDEX IF NOT EXISTS IDX_QH_MAT_DATABASE_NAME ON QUERY_HISTORY_MATERIALIZED(DATABASE_NAME);
CREATE INDEX IF NOT EXISTS IDX_QH_MAT_WAREHOUSE_NAME ON QUERY_HISTORY_MATERIALIZED(WAREHOUSE_NAME);
CREATE INDEX IF NOT EXISTS IDX_QH_MAT_QUERY_TYPE ON QUERY_HISTORY_MATERIALIZED(QUERY_TYPE);

-- Grant permissions
GRANT SELECT ON QUERY_HISTORY_MATERIALIZED TO ROLE SYSADMIN;
GRANT SELECT ON QUERY_HISTORY_MATERIALIZED TO ROLE ACCOUNTADMIN;
GRANT ALL ON QUERY_HISTORY_MATERIALIZED TO ROLE ACCOUNTADMIN;
...
SELECT 
    ...
    MAX(MATERIALIZED_AT) AS materialization_timestamp
